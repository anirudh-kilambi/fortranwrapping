...
static PyObject* __pyx_convert__to_py_struct__geo(struct geo s);
...
static struct geo __pyx_convert__from_py_struct__geo(PyObject *); /*proto*/
...
static const char __pyx_k_pysummation_pyx[] = "pysummation.pyx";
...
static PyObject *__pyx_kp_s_pysummation_pyx;
...
static PyObject *__pyx_pf_7pygfunc_f(CYTHON_UNUSED PyObject *__pyx_self, struct geo __pyx_v_v1, struct geo __pyx_v_v2); /* proto */
...
static PyObject *__pyx_pw_7pygfunc_1f(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  struct geo __pyx_v_v1;
  struct geo __pyx_v_v2;
  int __pyx_lineno = 0;
  ...
  __Pyx_RefNannySetupContext("f (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_v2)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("f", 1, 2, 2, 1); __PYX_ERR(0, 7, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "f") < 0)) __PYX_ERR(0, 7, __pyx_L3_error)
      }
    ...
    __pyx_v_v1 = __pyx_convert__from_py_struct__geo(values[0]); if (unlikely(PyErr_Occurred())) __PYX_ERR(0, 7, __pyx_L3_error)
    __pyx_v_v2 = __pyx_convert__from_py_struct__geo(values[1]); if (unlikely(PyErr_Occurred())) __PYX_ERR(0, 7, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("f", 1, 2, 2, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 7, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("pygfunc.f", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_7pygfunc_f(__pyx_self, __pyx_v_v1, __pyx_v_v2);
...
static PyObject *__pyx_pf_7pygfunc_f(CYTHON_UNUSED PyObject *__pyx_self, struct geo __pyx_v_v1, struct geo __pyx_v_v2) {
  struct geo __pyx_v_value;
 ...
 *     return value
 */
  c_gfunc(((struct geo *)(&__pyx_v_v1)), ((struct geo *)(&__pyx_v_v2)), ((struct geo *)(&__pyx_v_value)));
 ...
 */
  ...
  __pyx_t_1 = __pyx_convert__to_py_struct__geo(__pyx_v_value); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 12, __pyx_L1_error)
 ...
 * 
 * @cname("__pyx_convert__from_py_struct__geo")
 * cdef struct_type __pyx_convert__from_py_struct__geo(obj) except *:             # <<<<<<<<<<<<<<
 *     cdef struct_type result
 *     if not PyMapping_Check(obj):
 */

static struct geo __pyx_convert__from_py_struct__geo(PyObject *__pyx_v_obj) {
  struct geo __pyx_v_result;
  ...
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("__pyx_convert__from_py_struct__geo", 0);
 ...
 */
    ...
    if (__pyx_t_6) {
      __Pyx_AddTraceback("FromPyStructUtility.__pyx_convert__from_py_struct__geo", __pyx_clineno, __pyx_lineno, __pyx_filename);
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_kp_s_pysummation_pyx, __pyx_k_pysummation_pyx, sizeof(__pyx_k_pysummation_pyx), 0, 0, 1, 0},
 ...
 *         geo value
 */
  __pyx_tuple__3 = PyTuple_Pack(3, __pyx_n_s_v1, __pyx_n_s_v2, __pyx_n_s_value); if (unlikely(!__pyx_tuple__3)) __PYX_ERR(0, 7, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__3);
  __Pyx_GIVEREF(__pyx_tuple__3);
  __pyx_codeobj__4 = (PyObject*)__Pyx_PyCode_New(2, 0, 3, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__3, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_pysummation_pyx, __pyx_n_s_f, 7, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__4)) __PYX_ERR(0, 7, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
 ...
 *         geo value
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_7pygfunc_1f, NULL, __pyx_n_s_pygfunc); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 7, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
