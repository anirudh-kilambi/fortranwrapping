...
#define __PYX_HAVE__pyginterpolation
#define __PYX_HAVE_API__pyginterpolation
/* Early includes */
#include "pyginterpolation.h"
#ifdef _OPENMP
#include <omp.h>
#endif /* _OPENMP */
...
static PyObject* __pyx_convert__to_py_geo(geo s);
...
/* Module declarations from 'pyginterpolation' */
static int __Pyx_carray_from_py_float(PyObject *, float *, Py_ssize_t); /*proto*/
static geo __pyx_convert__from_py_geo(PyObject *); /*proto*/
...
#define __Pyx_MODULE_NAME "pyginterpolation"
extern int __pyx_module_is_main_pyginterpolation;
int __pyx_module_is_main_pyginterpolation = 0;

/* Implementation of 'pyginterpolation' */
...
static const char __pyx_k_pyginterpolation[] = "pyginterpolation";
static const char __pyx_k_cline_in_traceback[] = "cline_in_traceback";
static const char __pyx_k_pyginterpolation_pyx[] = "pyginterpolation.pyx";
static const char __pyx_k_No_value_specified_for_struct_at[] = "No value specified for struct attribute 'coordinates'";
static const char __pyx_k_No_value_specified_for_struct_at_2[] = "No value specified for struct attribute 'weight'";
...
static PyObject *__pyx_n_s_pyginterpolation;
static PyObject *__pyx_kp_s_pyginterpolation_pyx;
...
static PyObject *__pyx_pf_16pyginterpolation_f(CYTHON_UNUSED PyObject *__pyx_self, geo __pyx_v_v1, geo __pyx_v_v2); /* proto */
...
/* Python wrapper */
static PyObject *__pyx_pw_16pyginterpolation_1f(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyMethodDef __pyx_mdef_16pyginterpolation_1f = {"f", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_16pyginterpolation_1f, METH_VARARGS|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_16pyginterpolation_1f(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  geo __pyx_v_v1;
  geo __pyx_v_v2;
  int __pyx_lineno = 0;
  ...
  __Pyx_RefNannySetupContext("f (wrapper)", 0);
  {
    ...
    __pyx_v_v1 = __pyx_convert__from_py_geo(values[0]); if (unlikely(PyErr_Occurred())) __PYX_ERR(0, 10, __pyx_L3_error)
    __pyx_v_v2 = __pyx_convert__from_py_geo(values[1]); if (unlikely(PyErr_Occurred())) __PYX_ERR(0, 10, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("f", 1, 2, 2, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 10, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("pyginterpolation.f", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_16pyginterpolation_f(__pyx_self, __pyx_v_v1, __pyx_v_v2);
...
static PyObject *__pyx_pf_16pyginterpolation_f(CYTHON_UNUSED PyObject *__pyx_self, geo __pyx_v_v1, geo __pyx_v_v2) {
  geo __pyx_v_value;
  ...
  /* "pyginterpolation.pyx":13
 *     cdef geo value
 * 
 *     c_geo_manipulate(<geo*> &v1,<geo*> &v2,<geo*> &value)             # <<<<<<<<<<<<<<
 *     return value
 */
  c_geo_manipulate(((geo *)(&__pyx_v_v1)), ((geo *)(&__pyx_v_v2)), ((geo *)(&__pyx_v_value)));

  /* "pyginterpolation.pyx":14
 * 
 *     c_geo_manipulate(<geo*> &v1,<geo*> &v2,<geo*> &value)
 *     return value             # <<<<<<<<<<<<<<
 */
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = __pyx_convert__to_py_geo(__pyx_v_value); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 14, __pyx_L1_error)
 ...
 * 
 * @cname("__pyx_convert__from_py_geo")
 * cdef struct_type __pyx_convert__from_py_geo(obj) except *:             # <<<<<<<<<<<<<<
 *     cdef struct_type result
 *     if not PyMapping_Check(obj):
 */

static geo __pyx_convert__from_py_geo(PyObject *__pyx_v_obj) {
  geo __pyx_v_result;
  ...
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("__pyx_convert__from_py_geo", 0);
 ...
 *         value = obj['coordinates']             # <<<<<<<<<<<<<<
 *     except KeyError:
 *         raise ValueError("No value specified for struct attribute 'coordinates'")
 */
      __pyx_t_2 = __Pyx_PyObject_Dict_GetItem(__pyx_v_obj, __pyx_n_s_coordinates); if (unlikely(!__pyx_t_2)) __PYX_ERR(1, 17, __pyx_L4_error)
      __Pyx_GOTREF(__pyx_t_2);
 ...
 */
    ...
    if (__pyx_t_6) {
      __Pyx_AddTraceback("FromPyStructUtility.__pyx_convert__from_py_geo", __pyx_clineno, __pyx_lineno, __pyx_filename);
 ...
 *         value = obj['weight']
 */
  if (unlikely(__Pyx_carray_from_py_float(__pyx_v_value, __pyx_t_10, 2) < 0)) __PYX_ERR(1, 20, __pyx_L1_error)
  memcpy(&(__pyx_v_result.coordinates[0]), __pyx_t_10, sizeof(__pyx_v_result.coordinates[0]) * (2));
 ...
 * 
 */
  __pyx_t_11 = __pyx_PyFloat_AsFloat(__pyx_v_value); if (unlikely((__pyx_t_11 == (float)-1) && PyErr_Occurred())) __PYX_ERR(1, 25, __pyx_L1_error)
  __pyx_v_result.weight = __pyx_t_11;
...
static int __pyx_pymod_exec_pyginterpolation(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_pyginterpolation},
  {0, NULL}
};
#endif
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_pyginterpolation, __pyx_k_pyginterpolation, sizeof(__pyx_k_pyginterpolation), 0, 0, 1, 1},
  {&__pyx_kp_s_pyginterpolation_pyx, __pyx_k_pyginterpolation_pyx, sizeof(__pyx_k_pyginterpolation_pyx), 0, 0, 1, 0},
 ...
 * 
 */
  __pyx_tuple__3 = PyTuple_Pack(3, __pyx_n_s_v1, __pyx_n_s_v2, __pyx_n_s_value); if (unlikely(!__pyx_tuple__3)) __PYX_ERR(0, 10, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__3);
  __Pyx_GIVEREF(__pyx_tuple__3);
  __pyx_codeobj__4 = (PyObject*)__Pyx_PyCode_New(2, 0, 3, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__3, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_pyginterpolation_pyx, __pyx_n_s_f, 10, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__4)) __PYX_ERR(0, 10, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initpyginterpolation(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initpyginterpolation(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_pyginterpolation(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_pyginterpolation(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_pyginterpolation(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'pyginterpolation' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #elif PY_MAJOR_VERSION >= 3
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_pyginterpolation(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("pyginterpolation", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_pyginterpolation) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "pyginterpolation")) {
      if (unlikely(PyDict_SetItemString(modules, "pyginterpolation", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 * 
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_16pyginterpolation_1f, NULL, __pyx_n_s_pyginterpolation); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 10, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_f, __pyx_t_1) < 0) __PYX_ERR(0, 10, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;

  /* "pyginterpolation.pyx":1
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init pyginterpolation", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init pyginterpolation");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
...
static PyObject* __pyx_convert__to_py_geo(geo s) {
  ...
  member = __Pyx_carray_to_py_float(s.coordinates, 2); if (unlikely(!member)) goto bad;
  if (unlikely(PyDict_SetItem(res, __pyx_n_s_coordinates, member) < 0)) goto bad;
  Py_DECREF(member);
